...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 263fdd7e-5dc9-4ffd-b2f4-fa9c1f1d1c7a
```

> `263fdd7e-5dc9-4ffd-b2f4-fa9c1f1d1c7a` is the password of the certificate, you can change it to any password you want.
